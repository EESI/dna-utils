...
all: libkmer.o libkmer.so libkmer.a kmer_total_count kmer_frequency_per_sequence
...
libkmer.a: libkmer.o
	...
	chmod +x libkmer.a
kmer_total_count: libkmer.a
	$(CC) kmer_total_count.c -o kmer_total_count $(CLIBS) $(CFLAGS) -DSHARED=0
kmer_frequency_per_sequence: libkmer.a
	$(CC) kmer_frequency_per_sequence.c -o kmer_frequency_per_sequence $(CLIBS) $(CFLAGS)

clean:
	rm -vf kmer_total_count kmer_frequency_per_sequence libkmer.so libkmer.a libkmer.o
